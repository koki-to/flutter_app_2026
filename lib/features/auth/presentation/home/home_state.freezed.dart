...
mixin _$HomeState {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, isSigningOut, isDeletingAccount, errorMessage);

  @override
  String toString() {
    return 'HomeState(isSigningOut: $isSigningOut, isDeletingAccount: $isDeletingAccount, errorMessage: $errorMessage)';
  }
}
...
abstract mixin class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isSigningOut, bool isDeletingAccount, String? errorMessage});
}
...
extension HomeStatePatterns on HomeState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(
            bool isSigningOut, bool isDeletingAccount, String? errorMessage)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _HomeState() when $default != null:
        return $default(
            _that.isSigningOut, _that.isDeletingAccount, _that.errorMessage);
      case _:
        return orElse();
    }
  }
