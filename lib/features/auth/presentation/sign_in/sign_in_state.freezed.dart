...
mixin _$SignInState {
  ...
  int get hashCode => Object.hash(
      runtimeType, email, password, isLoading, obscurePassword, errorMessage);
...
extension SignInStatePatterns on SignInState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String email, String password, bool isLoading,
            bool obscurePassword, String? errorMessage)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SignInState() when $default != null:
        return $default(_that.email, _that.password, _that.isLoading,
            _that.obscurePassword, _that.errorMessage);
      case _:
        return orElse();
    }
  }
