...
mixin _$ForgotPasswordState {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, email, isLoading, isEmailSent, errorMessage);

  @override
  String toString() {
    return 'ForgotPasswordState(email: $email, isLoading: $isLoading, isEmailSent: $isEmailSent, errorMessage: $errorMessage)';
  }
}
...
abstract mixin class $ForgotPasswordStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String email, bool isLoading, bool isEmailSent, String? errorMessage});
}
...
extension ForgotPasswordStatePatterns on ForgotPasswordState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String email, bool isLoading, bool isEmailSent,
            String? errorMessage)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ForgotPasswordState() when $default != null:
        return $default(_that.email, _that.isLoading, _that.isEmailSent,
            _that.errorMessage);
      case _:
        return orElse();
    }
